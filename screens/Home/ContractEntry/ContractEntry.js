            ...
            {loading ? (
                <>
                    ...
                    <ScrollView keyboardShouldPersistTaps='always' style={styles.container}>
                        ...
                        <View style={{ borderBottomColor: 'grey', borderBottomWidth: 1, marginTop: 0 }} />
             ...
             <View style={{ marginBottom: 50 }}>
                            <View style={[styles.column, { top: 12 }]}>
                                <DropDownPicker
                                    items={[
                                        { label: 'Delivery', value: 'Delivery', hidden: true },
...
/>
         ...
         <SelectTwo items={cityItems} selectedItem={selectedCityItems} handleId={handleCityId} width={wp('80%')} placeholder="City" borderColor="#ccc" />
                            </View>

                            <View style={[styles.column, { top: 12 }]}>
                            <TextInput
                                    style={[styles.input, { backgroundColor: "#D3FD7A" }]}
                                    placeholder="Dilevery Details"
                                    ref={dealOneRef}
                                    onFocus={() => onFocusChange("dealOne")}
                                    onBlur={() => onBlurChange("dealOne")}
                                    defaultValue={dealNumberOne}
    ...
    <View style={{ borderRadius: 6, margin: 3,flex:1,width:wp("50%") }}>
      ...
      <View style={[styles.column, { top: 12 }]}>
                        ...
                        <View style={[styles.column, { justifyContent: "center",marginBottom:30 }]}>
